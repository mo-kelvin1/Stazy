...
public class AuthenticationFilter extends HttpFilter {
    private final List<String> unsecuredEndpoints = Arrays.asList("/api/v1/auth/login", "/api/v1/auth/register",
            "/api/v1/auth/send-password-reset-token", "/api/v1/auth/reset-password");
