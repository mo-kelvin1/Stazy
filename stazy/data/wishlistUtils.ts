...
export const addToWishlist = async (item: Property | Experience | Service): Promise<boolean> => {
  try {
    ...
    const response = await fetch('http://10.60.32.210:8080/api/wishlist/add', {
      method: 'POST',
      headers: {
...
export const removeFromWishlistByEntityId = async (entityId: string, itemType: string): Promise<boolean> => {
  try {
    ...
    const response = await fetch(`http://10.60.32.210:8080/api/wishlist/remove?entityId=${entityId}&itemType=${itemType.toUpperCase()}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
export const removeFromWishlist = async (wishlistId: string): Promise<boolean> => {
  try {
    ...
    const response = await fetch(`http://10.60.32.210:8080/api/wishlist/remove?entityId=${entityId}&itemType=${itemType}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
export const isInWishlist = async (id: string, itemType: string): Promise<boolean> => {
  try {
    ...
    const response = await fetch(`http://10.60.32.210:8080/api/wishlist/check?entityId=${id}&itemType=${itemType.toUpperCase()}`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
export const getWishlistItems = async (): Promise<WishlistItem[]> => {
  try {
    ...
    const response = await fetch('http://10.60.32.210:8080/api/wishlist/items', {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
...
export const getWishlistCount = async (): Promise<number> => {
  try {
    ...
    const response = await fetch('http://10.60.32.210:8080/api/wishlist/count', {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
      },
